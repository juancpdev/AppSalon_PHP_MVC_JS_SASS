...
class Usuario extends ActiveRecord {
    ...
    // Mensajes de validación para olvide password
    ...
    // Mensajes de validación para el password
    ...
    public function comprobarPasswordAndVerificado($password) {
        ...
        if(!$resultado || !$this->confirmado) {
            self::$alertas['error'][] = "Password incorrecto o el usuario no fue confirmado";
        } else {
            return true;
        }
    }
